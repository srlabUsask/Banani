...
class heat_inventory:
    ...
    # templates
    host_entry = Template('$ipaddress             ansible_connection=ssh  ansible_ssh_user=$ssh_user ansible  ansible_ssh_private_key_file=$private_key_file')
...
$nodes
    ...
    def load_heat_output(self):
        ...
        foo = subprocess.Popen("echo [ && heat output-show banani-stack --all --format json  | sed -e 's/}/},/g' | head -n -1 && echo } && echo ]", shell=True, stdout=subprocess.PIPE).stdout.read()
        print(foo)
