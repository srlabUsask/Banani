...
#heat stack-delete hadoop-stack 
...
#ssh -i ~/.ssh/hdpspark.pem hadoop@206.12.101.241
...
#hadoop jar /usr/local/hadoop/share/hadoop/mapreduce/hadoop-mapreduce-examples-2.7